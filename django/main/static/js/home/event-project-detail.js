...
//         createAudioControls(this, "api/get-stem-file", "stem-filename");
//     });
// }

// function addTrackControls(node){
//     node.addEventListener('click', function(){
//         createAudioControls(this, "api/get-track-file", "track-filename");
//     });
// }
...
//                 content.setAttribute("stem-filename", result[i]["stem_filename"]);
...
// // Play/Pause audio
// function createAudioControls(node, url, audioId){
//     for (i = 0; i < audio_stack.length; ++i){
//         if (!audio_stack[i]["audio"].paused){
//             audio_stack[i]["audio"].pause();
//             if (audio_stack[i]["audio"].getAttribute("stem-id").includes(node.getAttribute(audioId))){
...
//     var formData = new FormData();
//     formData.append("filename", node.getAttribute(audioId));
